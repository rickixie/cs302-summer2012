...
/**
 * This is a class for the shape Triangle_Right_Down, which is a subclass of triangle that construct a shape that
 * that has a base of a same size square, but is the isosceles right triangle on the right bottom side.
 * @author rickixie
 *
 */
public class Triangle_Right_Down extends Triangle implements AreaMeasurable {

	private double base;
	/**
	 * This is the default constructor for Triangle_Right_Down, which is a type of triangle.
	 ...
	 */
	public Triangle_Right_Down(Color c, double originX, double originY, double baseP)
